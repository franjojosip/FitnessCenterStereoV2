...
import StepViewStore from '../stores/StepViewStore';
import Modal from 'react-bootstrap/Modal'

@inject(stores => ({
    stepViewStore: new StepViewStore(stores.rootStore)
}))
@observer
class Step extends React.Component {
    render() {
        const { searchQuery, isLoading, columns, isDeleting, page, recordsPerPage, displayItems, itemToDeleteName, onUpdate, onCreate, onFind, onDelete, onSearchQueryChange, onRecordsPerPageChange, onSortChange, onPageChange, onConfirmDelete, onCancelDelete } = this.props.stepViewStore;
        return (
            <React.Fragment>
                <Layout>
