...
@inject(
    i=>({
        viewStore:new PlanViewStore(i.rootStore)
    })
)
@observer
class Plan extends React.Component {
    render() {
        const { searchQuery, isLoading, columns, isDeleting, page, recordsPerPage, displayItems, itemToDeleteName, onUpdate, onCreate, onFind, onDelete, onSearchQueryChange, onRecordsPerPageChange, onSortChange, onPageChange, onConfirmDelete, onCancelDelete } = this.props.viewStore;
        return (
            <React.Fragment>
                <Layout>
